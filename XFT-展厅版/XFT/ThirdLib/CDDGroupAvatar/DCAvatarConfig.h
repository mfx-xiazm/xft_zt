...
static int32_t DCCustomCount  = 4;// 自定义扩展字段
...
#define DCURLStr(avaStr) ([avaStr hasPrefix:@"http"]) ? avaStr : [NSString stringWithFormat:@"%@%@",[DCAvatarManager sharedAvatar].baseUrl,avaStr]
